...
class Order(models.Model):
    ...
    grand_total = models.DecimalField(max_digits=10, decimal_places=2, null=False, default=0)  # do i need grand total if each item only has one quantity?
    # Add stripe pid
...
class OrderLineItem(models.Model):
    ...
    quantity = models.IntegerField(null=False, blank=False, default=0)  # is this quantity for number of items in bag or quantity of same items
